#!/usr/bin/env python3
"""Script to update the handleUploadNOS function with better validation and debugging"""

# Read the file
with open('client/index.html', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# New function code with better validation
...
if start_index != -1:
    ...
    if end_index != -1:
        ...
        print("✅ Successfully updated handleUploadNOS with improved validation!")
    else:
